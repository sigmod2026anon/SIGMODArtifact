...
void print_usage(const char* prog_name) {
    ...
    std::cout << "Inject poison into a single dataset file using consecutive approach with endpoints (duplicate allowed)" << std::endl;
    std::cout << std::endl;
...
int main(int argc, char* argv[]) {
    try {
        ...
        // Inject poison using consecutive approach with endpoints (duplicate allowed)
        auto result = poisoning::inject_poison_consecutive_w_endpoints_duplicate_allowed_to_file(input_file, output_file, poison_num);
        
        {
            ...
            json_entry << "{\n"
                      ...
                      << "  \"approach\": \"consecutive_w_endpoints_duplicate_allowed\"\n"
                      << "}";
            ...
            //          << info.dataset_name << " (lambda=" << poison_num << ", consecutive_w_endpoints_duplicate_allowed)" << std::endl;
        }
