...
void print_usage(const char* prog_name) {
    ...
    std::cout << "Inject poison into a single dataset file with duplicate allowed" << std::endl;
    std::cout << std::endl;
...
int main(int argc, char* argv[]) {
    try {
        ...
        // Inject poison with duplicate allowed
        auto result = poisoning::inject_poison_duplicate_allowed_to_file(input_file, output_file, poison_num);
        
        {
            ...
            //          << info.dataset_name << " (lambda=" << poison_num << ")" << std::endl;
        }
