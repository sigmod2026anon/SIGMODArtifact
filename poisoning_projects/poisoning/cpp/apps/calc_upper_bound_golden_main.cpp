...
int main(int argc, char* argv[]) {
    try {
        if (argc != 4) {
            ...
            std::cerr << "  Algorithm: Golden Section Search on W-axis" << std::endl;
            return 1;
        }
        ...
        // Calculate upper bound (golden section search based)
        auto [w_star, mse_star, time_taken] = calc_upper_bound_golden_section(xs, lambda, 1e-12, 50);
        ...
        //          << info.dataset_name << " (lambda=" << lambda << ", algorithm=golden_section)" << std::endl;
